namespace SpriteKind {
    export const skate = SpriteKind.create()
    export const lixo = SpriteKind.create()
}
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.lixo, function (sprite, otherSprite) {
    info.changeLifeBy(-2)
    scene.cameraShake(4, 500)
    otherSprite.destroy(effects.bubbles)
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.skate, function (sprite, otherSprite) {
    info.changeLifeBy(1)
    otherSprite.destroy()
    sprite.startEffect(effects.hearts, 100)
    music.baDing.play()
...
game.onUpdateInterval(500, function () {
    ...
    if (choice == 1) {
        projectile = sprites.createProjectileFromSide(img`
            ...
            . . . . . f f f f f . . . . . . 
            . . . f f f f f f f f f f f f . 
            . f f d d f f c c c c c c c c f 
            f d d d d f f f f f f f f f f f 
            f d d d d d f c c c c c c c c f 
            f d d d d d f f f f f f f f f f 
            f d d d d d f c c c c c c c c f 
            f d d d d d f f f f f f f f f f 
            . f f d d f f c c c c c c c c f 
            . . . f f f f f f f f f f f f . 
    ...
    if (info.score() == 10) {
        projectile = sprites.createProjectileFromSide(img`
            ...
            . . . . . . . . . . . . . . . . 
            `, 55, 0)
        projectile.setKind(SpriteKind.skate)
    }
    projectile.y = randint(25, 110)
    if (info.score() == 25) {
        projectile = sprites.createProjectileFromSide(img`
            ...
            . 2 2 2 5 5 f c c c c c c c c f 
            2 2 5 5 5 5 f f f f f f f f f f 
            . 2 2 5 5 5 f c c c c c c c c f 
            . . . 2 5 5 f f f f f f f f f f 
            . 2 2 2 5 5 f c c c c c c c c f 
            2 2 2 5 5 5 f f f f f f f f f f 
            . 2 2 2 5 5 f c c c c c c c c f 
            . . . 2 2 2 f f f f f f f f f . 
            . . . . . f f f f f . . . . . . 
            . . . . . . . . . . . . . . . . 
            ...
            . . . . . . . . . . . . . . . . 
            `, 55, 0)
        projectile.setKind(SpriteKind.lixo)
    }
    projectile.y = randint(25, 110)
})
